  ...
  return (
    <div className="rounded-xl border border-accent/30 bg-accent/5 p-3">
      <div className="flex items-center justify-between">
        <div className="text-xs font-semibold uppercase tracking-wider font-mono text-accent-foreground">Nudge</div>
      ...
      {text && (
        <div className="mt-2">
          <div className="whitespace-pre-wrap rounded-lg bg-card p-3 text-sm">{text}</div>
